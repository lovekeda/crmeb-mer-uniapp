<template>
    ...
    <!-- #endif -->
      ...
      <view class="section wrap" @click="goQRCode">
    ...
    <qr-code-popup :show="qrCodeShow" :mer-id="merid" :shop-name="merchantAPPInfo.name"
                   :shop-logo="merchantAPPInfo.avatar" @close="qrCodeShow = false"></qr-code-popup>
	</view>
</template>
...
<script>
  ...
  import Navbar from "@/components/navBar.vue";
	import QrCodePopup from "./QR_code.vue";
	let app = getApp();
	export default {
