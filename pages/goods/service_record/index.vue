...
::v-deep .uni-checkbox-input.uni-checkbox-input-checked, ::v-deep .uni-radio-input-checked {
  border: 1px solid #2A7EFB !important;
  background-color: #2A7EFB !important;
  color: #FFF !important;
}

::v-deep .wx-checkbox-input.wx-checkbox-input-checked , ::v-deep .wx-radio-input-checked{
  border: 1px solid #2A7EFB !important;
  background-color: #2A7EFB !important;
  color: #FFF !important;
}
